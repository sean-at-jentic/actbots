...
class BaseOutbox(ABC):
    ...
    def send_message(self, goal_id: str, message_type: MessageType, content: Any, **kwargs) -> None:
        """
        ...
        if message_type == MessageType.PROGRESS_UPDATE:
            ...
            self.send_status_change(goal_id, kwargs.get('old_status', ''), kwargs.get('new_status', ''))
